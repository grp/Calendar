...
#import "XCModelController.h"

#import "XCDataViewController.h"

@interface XCRootViewController ()
@property (readonly, strong, nonatomic) XCModelController *modelController;
@end
...
- (void)viewDidLoad
{
    ...
    XCDataViewController *startingViewController = [self.modelController viewControllerAtIndex:0 storyboard:self.storyboard];
...
- (XCModelController *)modelController
{
     // Return the model controller object, creating it if necessary.
     // In more complex implementations, the model controller may be passed to the view controller.
    if (!_modelController) {
        _modelController = [[XCModelController alloc] init];
    }
...
- (UIPageViewControllerSpineLocation)pageViewController:(UIPageViewController *)pageViewController spineLocationForInterfaceOrientation:(UIInterfaceOrientation)orientation
{
    ...
    XCDataViewController *currentViewController = self.pageViewController.viewControllers[0];
